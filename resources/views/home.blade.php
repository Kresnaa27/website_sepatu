...
<section class="hero-section">
    <div class="container hero-grid">
        <div class="hero-content">
            <span style="color: var(--tridatu-red); font-weight: 800; font-size: 11px; letter-spacing: 2px;">TRIDATU EDITION</span>
            <h1>WALK BEYOND <br><span>LIMITS</span></h1>
            <p>Explore our premium Tridatu collection for unyielding steps, crafted with soul from the Island of Gods.</p>
...
<div class="container">
    ...
    <div class="promo-grid">
        <div class="promo-card">
            <div class="promo-info">
                ...
                <a href="#" class="btn-red" style="padding: 8px 16px; font-size: 11px;">Explore Tridatu Collection &rarr;</a>
            </div>
        </div>
        <div class="promo-card">
            <div class="promo-info">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 40px; margin-bottom: 20px;">
        ...
        <a href="#" style="color: var(--text-muted); font-size: 12px; text-decoration: none; font-weight: 700;">View all</a>
    </div>
